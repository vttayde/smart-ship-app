...
export const SERVICE_TYPES: ServiceType[] = [
  ...
  },
  {
    ...
    features: ['Faster delivery', 'Priority handling', 'Real-time tracking', 'SMS notifications'],
    isActive: true,
  },
  {
    id: 'overnight',
    ...
    features: ['Same day delivery', 'Dedicated vehicle', 'Live tracking', 'Premium support'],
    isActive: true,
  },
];
