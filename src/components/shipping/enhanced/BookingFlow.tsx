                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-1 text-sm">
                            ...
                            <div>{pickup.city}, {pickup.state} - {pickup.pincode}</div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-1 text-sm">
                            ...
                            <div>{delivery.city}, {delivery.state} - {delivery.pincode}</div>
                        </div>
                    </CardContent>
                </Card>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <div className="font-mono text-lg font-semibold">{bookingData.trackingNumber}</div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div>{bookingData.courierName} - {bookingData.serviceType}</div>
                                </div>
                            </div>
                            <div className="space-y-3">
                                <div>
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between">
                    {[
                        ...
                        const isCompleted = ['review', 'payment', 'booking'].indexOf(currentStep) >
