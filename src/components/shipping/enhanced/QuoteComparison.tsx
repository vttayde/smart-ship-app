        ...
        {sortedQuotes.map(quote => (
          <Card
            ...
            className={`cursor-pointer transition-all duration-200 ${
              selectedQuote === quote.courierCode
                  ...
                  <div className='flex-1'>
                    <div className='flex items-center gap-3 mb-2'>
                      ...
                      <div className='flex items-center'>
                        ...
                        <span className='text-sm text-gray-600 ml-1'>{quote.courierRating}</span>
                      </div>
                    </div>

                    <div className='text-lg text-gray-700 mb-1'>{quote.serviceType.name}</div>
