      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6'>
        {comparison.cheapest && (
          <div className='bg-green-50 p-3 rounded-lg border border-green-200'>
            ...
            <div className='text-sm text-gray-600'>
              {formatCurrency(comparison.cheapest.pricing.totalPrice)}
            </div>
          </div>
        )}
        ...
        {comparison.fastest && (
          <div className='bg-blue-50 p-3 rounded-lg border border-blue-200'>
            ...
            <div className='text-sm text-gray-600'>
              {comparison.fastest.delivery.minDays}-{comparison.fastest.delivery.maxDays} days
            </div>
          </div>
        )}
        ...
        {comparison.mostReliable && (
          <div className='bg-yellow-50 p-3 rounded-lg border border-yellow-200'>
            ...
            <div className='font-semibold'>
              {comparison.mostReliable.courierService.displayName}
            </div>
            <div className='text-sm text-gray-600'>
              {comparison.mostReliable.courierService.rating}★ rating
            </div>
          </div>
        )}
