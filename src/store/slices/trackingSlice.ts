...
export const refreshTrackingData = createAsyncThunk(
    ...
    async (
        params: { trackingNumber?: string; orderId?: string },
        { rejectWithValue }
    ) => {
        try {
            const searchParams = new URLSearchParams();
...
// Selectors
export const selectCurrentTracking = (state: { tracking: TrackingState }) => state.tracking.currentTracking;
export const selectTrackingHistory = (state: { tracking: TrackingState }) => state.tracking.trackingHistory;
...
export const selectAutoRefreshEnabled = (state: { tracking: TrackingState }) => state.tracking.autoRefreshEnabled;
export const selectRefreshInterval = (state: { tracking: TrackingState }) => state.tracking.refreshInterval;
export const selectTrackingLastRefresh = (state: { tracking: TrackingState }) => state.tracking.lastRefresh;
export const selectSearchHistory = (state: { tracking: TrackingState }) => state.tracking.searchHistory;
