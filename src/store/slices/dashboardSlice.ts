...
export const selectRecentShipments = (state: { dashboard: DashboardState }) => state.dashboard.recentShipments;
export const selectCourierPerformance = (state: { dashboard: DashboardState }) => state.dashboard.courierPerformance;
...
export const selectDashboardErrors = (state: { dashboard: DashboardState }) => state.dashboard.error;
