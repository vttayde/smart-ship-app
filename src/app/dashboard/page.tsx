                  ...
                  {recentShipments.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {recentShipments.map((shipment) => {
                        const config = statusConfig[shipment.status.toUpperCase() as keyof typeof statusConfig] || statusConfig.PENDING;
                        ...
                        return (
                          <div key={shipment.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">
                                  {shipment.deliveryAddress?.city || 'N/A'}, {shipment.deliveryAddress?.state || 'N/A'}
                                </p>
                            ...
                            <div className="flex items-center space-x-3">
                              <span className="font-medium text-gray-900">₹{shipment.totalAmount}</span>
