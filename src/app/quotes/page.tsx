    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {!loading && quotes.length > 0 && (
          <ComparisonSummary quotes={quotes} />
        )}
          ...
          <Card className="overflow-hidden">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">{quote.serviceType.displayName}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
            ...
            {quotes.map((quote) => (
              showBreakdown === quote.id && (
                <div key={`breakdown-${quote.id}`} className="border-t border-gray-200 bg-gray-50 px-6 py-4">
                  <h4 className="font-medium mb-3">Price Breakdown - {quote.courierService.displayName}</h4>
        ...
        <div className="mt-8 text-center space-y-4">
          ...
          {quotes.length > 0 && (
            <div className="text-sm text-gray-500">
              💡 Tip: Use filters to narrow down options or comparison view to see all details at once
            </div>
          )}
        </div>
      </div>
