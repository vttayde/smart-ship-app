        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto'>
              Compare rates from 5+ courier partners, book instantly, and track in real-time. The
              smartest way to send packages across India.
            </p>
          </div>
          ...
          <Card className='max-w-5xl mx-auto shadow-xl border-0'>
            <CardHeader className='text-center pb-6'>
              ...
              <p className='text-gray-600'>
                Enter your shipment details to compare rates from multiple couriers
              </p>
            </CardHeader>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Experience the future of logistics with our comprehensive platform designed for modern
              shipping needs
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <Card className='text-center p-8 hover:shadow-lg transition-shadow border-0 shadow-md'>
              <CardContent className='pt-6'>
                ...
                <p className='text-gray-600 mb-4'>
                  Delhivery, Shadowfax, Ekart, Blue Dart & more trusted partners for nationwide
                  coverage
                </p>
            ...
            <Card className='text-center p-8 hover:shadow-lg transition-shadow border-0 shadow-md'>
              <CardContent className='pt-6'>
                ...
                <p className='text-gray-600 mb-4'>
                  Compare real-time rates from all partners and automatically get the best available
                  price
                </p>
                <div className='flex justify-center space-x-2'>
            ...
            <Card className='text-center p-8 hover:shadow-lg transition-shadow border-0 shadow-md'>
              <CardContent className='pt-6'>
                ...
                <p className='text-gray-600 mb-4'>
                  Live GPS tracking, delivery updates, and instant notifications for all your
                  shipments
                </p>
                <div className='flex justify-center space-x-2'>
