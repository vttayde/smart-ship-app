...
export default function OrderDetailsPage() {
  ...
  const config =
    statusConfig[order.status.toUpperCase() as keyof typeof statusConfig] || statusConfig.PENDING;
              ...
              <Card className={`${config.borderColor} border-l-4`}>
                <CardContent className='p-6'>
                  <div className='flex items-center justify-between mb-4'>
                    <div
                      className={`flex items-center space-x-2 px-4 py-2 rounded-full ${config.bgColor}`}
                    >
