...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowRight, CheckCircle, Truck, Shield, Star, UserPlus } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        setError('Account created successfully, but failed to sign in. Please try logging in manually.')
      } else {
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-purple-100">Join our growing community of satisfied shippers</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-purple-100">Your data and shipments are protected with enterprise-grade security</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-purple-100">Compare rates from 5+ courier partners in seconds</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 rounded-lg p-6">
              ...
              <p className="text-purple-100 italic">
                "Ship Smart has transformed our business logistics. We save 30% on shipping costs and our customers love the tracking experience!"
              </p>
