          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold mb-4">
                Welcome back to the future of shipping
              </h1>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">View all your shipments and analytics in one place</p>
                </div>
              </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  <p><strong>User:</strong> demo@smartship.com / demo123</p>
                  <p><strong>Admin:</strong> admin@smartship.com / admin123</p>
                </div>
              </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-6">
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-4 bg-white text-gray-500">Social login coming soon</span>
                      </div>
                    </div>
