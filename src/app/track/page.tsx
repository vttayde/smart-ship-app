  ...
  const handleTrack = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const order = orders.find(
        (o: { trackingNumber: string }) => o.trackingNumber === trackingNumber
      );
              ...
              <Card>
                <CardContent className='p-6'>
                  <div className='flex items-center justify-between mb-6'>
                    <div>
                      ...
                      <p className='text-gray-600'>
                        {trackingData.order.parcelContents} via{' '}
                        {trackingData.order.courierPartner?.name}
                      </p>
                    </div>
                  ...
                  {(() => {
                    const config =
                      statusConfig[
                        trackingData.status.toUpperCase() as keyof typeof statusConfig
                      ] || statusConfig.PENDING;
                    const StatusIcon = config.icon;
                    return (
                      <div
                        className={`flex items-center space-x-2 px-4 py-2 rounded-full ${config.bgColor} mb-6`}
                      >
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='flex items-start space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-600'>
                          {trackingData.order.pickupAddress?.city},{' '}
                          {trackingData.order.pickupAddress?.state}
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start space-x-3'>
            ...
            <CardContent className='p-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 text-sm'>
                <div>
                  ...
                  <p className='text-gray-600'>
                    Tracking numbers are usually 10-15 characters long and may contain letters and
                    numbers. Example: SPK123456789
                  </p>
                </div>
                <div>
                  <h4 className='font-medium text-gray-900 mb-2'>Update Frequency</h4>
                  <p className='text-gray-600'>
                    Tracking information is updated every few hours. If you don&apos;t see recent
                    updates, please check back later.
                  </p>
                </div>
                <div>
                  <h4 className='font-medium text-gray-900 mb-2'>Missing Package?</h4>
                  <p className='text-gray-600'>
                    If your package is delayed or missing, contact our support team with your
                    tracking number for assistance.
                  </p>
                </div>
                <div>
